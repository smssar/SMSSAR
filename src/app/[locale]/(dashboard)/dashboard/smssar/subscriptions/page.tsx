...
export default async function SmssarSubscriptionsPage({
  params,
  searchParams,
}: Props) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center gap-2">
          <ButtonLink
            href={`/${locale}/dashboard/smssar/subscriptions?page=${Math.max(1, page - 1)}&pageSize=${pageSize}`}
            variant="outline"
            size="sm"
          ...
          <ButtonLink
            href={`/${locale}/dashboard/smssar/subscriptions?page=${Math.min(totalPages, page + 1)}&pageSize=${pageSize}`}
            variant="default"
            size="sm"
          >
